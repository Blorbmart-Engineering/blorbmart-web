...
/* The cart-handle B, traced from the master artwork. The same path the
   landing page at www draws, so the mark writes itself the same way in both
   places. */
